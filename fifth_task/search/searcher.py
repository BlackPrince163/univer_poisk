...
INDEX_FILE_PATH = BASE_DIR.parent.joinpath("downloaded_pages").joinpath("index.txt")
TF_IDF_FILES_DIR = BASE_DIR.parent.joinpath("fourth_task").joinpath("lemmas_tf_idf")
INVERTED_INDEX_FILE_PATH = BASE_DIR.parent.joinpath("third_task").joinpath(
    "inverted_index.txt"
)
